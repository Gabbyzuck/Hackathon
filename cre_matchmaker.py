...
if __name__ == "__main__":
    ...
    if matches:
        ...
        for match in matches:
            print(f"Property Name: {match['name']}, Size: {match['square_feet']}, Cap rate: {match['noi'] / match['sale_price'] : %}, Class: {match['property_class']}")
            print(f"the data saved to - cre_matchmaker_output.json")
    else:
